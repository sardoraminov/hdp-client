<template>
  <div class="header-part">
    ...
    >
      ...
      <div class="c-titles">
        <h1 class="title font-mont font-extrabold text-[42px] leading-[58px]">
          <span class="text-primary">Birinchi</span> imtihonning o’zidayoq
          talaba bo’ling!
        </h1>
...
<script setup>
import pretty from "~/assets/img/pretty.jpg";
