<template>
  <div id="courses" class="course-part mb-32 sm:px-10">
    <div class="part-titles mt-20 text-center mb-8 px-4">
      ...
      <p class="desc mt-1 font-manr text-base">
        Biz sizga sifatli, tajribali ustozlar tomonidan alohida metodikalar
        asosida o'tiladigan va asosiysi hamyonbop bo'lgan kurslarni taklif
        qilamiz
      </p>
    </div>
    <div class="part-courses mt-5 relative sm:px-6 cursor-grab">
      ...
      >
        <circle cx="39" cy="200" r="200" fill="#00B4D8" fill-opacity="0.12" />
        <circle
          cx="70.2345"
          cy="410.235"
          r="50"
          transform="rotate(38.3471 70.2345 410.235)"
          fill="url(#paint0_linear_111_24)"
          
        />
        <defs>
          <linearGradient
            id="paint0_linear_111_24"
            x1="70.2345"
            y1="360.235"
            x2="120.235"
            y2="493.235"
